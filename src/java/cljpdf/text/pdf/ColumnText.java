...
import cljpdf.text.pdf.ArabicLigaturizer;
import cljpdf.text.pdf.BidiLine;
    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                cljpdf.text.List list = (cljpdf.text.List)element;
