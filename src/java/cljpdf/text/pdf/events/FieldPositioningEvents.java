...
public class FieldPositioningEvents extends PdfPageEventHelper implements PdfPCellEvent {
	...
	/**
	 * @see cljpdf.text.pdf.PdfPageEvent#onGenericTag(cljpdf.text.pdf.PdfWriter, cljpdf.text.Document, cljpdf.text.Rectangle, java.lang.String)
	 */
	...
	/**
	 * @see cljpdf.text.pdf.PdfPCellEvent#cellLayout(cljpdf.text.pdf.PdfPCell, cljpdf.text.Rectangle, cljpdf.text.pdf.PdfContentByte[])
	 */
