...
//        reader.getCatalog().remove(PdfName.ACROFORM);
    ...
    /**
     * @see cljpdf.text.pdf.PdfWriter#getPageReference(int)
     */
    ...
    /**
     * @see cljpdf.text.pdf.PdfWriter#addAnnotation(cljpdf.text.pdf.PdfAnnotation)
     */
    ...
    /**
     * @see cljpdf.text.pdf.PdfWriter#setOpenAction(cljpdf.text.pdf.PdfAction)
     */
    ...
    /**
     * @see cljpdf.text.pdf.PdfWriter#setOpenAction(java.lang.String)
     */
    ...
    /**
     * @see cljpdf.text.pdf.PdfWriter#setThumbnail(cljpdf.text.Image)
     */
    public void setThumbnail(cljpdf.text.Image image) {
