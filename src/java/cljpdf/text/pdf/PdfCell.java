 ...
 * <P>
 * When using variable borders ({@link cljpdf.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		cljpdf.text.Rectangle
 * @see		cljpdf.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link cljpdf.text.Rectangle}
