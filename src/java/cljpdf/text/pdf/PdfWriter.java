...
//	Open and Close methods + method that create the PDF
     ...
     * @see cljpdf.text.DocWriter#open()
     */
    public void open() {
        super.open();
        try {
     ...
     * @see cljpdf.text.DocWriter#close()
     */
    public void close() {
        if (open) {
...
//	[C2] PdfVersion interface
	...
	/**
	 * @see cljpdf.text.pdf.interfaces.PdfVersion#addDeveloperExtension(cljpdf.text.pdf.PdfDeveloperExtension)
	 * @since	2.1.6
	 */
...
// [C6] Actions (open and additional)
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfDocumentActions#setOpenAction(java.lang.String) */
    public void setOpenAction(String name) {
         pdf.setOpenAction(name);
     }

    /** @see cljpdf.text.pdf.interfaces.PdfDocumentActions#setOpenAction(cljpdf.text.pdf.PdfAction) */
    public void setOpenAction(PdfAction action) {
         pdf.setOpenAction(action);
     }

    /** @see cljpdf.text.pdf.interfaces.PdfDocumentActions#setAdditionalAction(cljpdf.text.pdf.PdfName, cljpdf.text.pdf.PdfAction) */
...
//  [C8] AcroForm
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfAnnotations#getAcroForm() */
    public PdfAcroForm getAcroForm() {
        return pdf.getAcroForm();
    }

    /** @see cljpdf.text.pdf.interfaces.PdfAnnotations#addAnnotation(cljpdf.text.pdf.PdfAnnotation) */
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfAnnotations#addCalculationOrder(cljpdf.text.pdf.PdfFormField) */
    public void addCalculationOrder(PdfFormField annot) {
        pdf.addCalculationOrder(annot);
    }

    /** @see cljpdf.text.pdf.interfaces.PdfAnnotations#setSigFlags(int) */
...
//  [C10] PDFX Conformance
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfXConformance#getPDFXConformance() */
    public int getPDFXConformance() {
        return pdfxConformance.getPDFXConformance();
    }

    /** @see cljpdf.text.pdf.interfaces.PdfXConformance#isPdfX() */
...
//  [U3] page actions (open and close)
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfPageActions#setPageAction(cljpdf.text.pdf.PdfName, cljpdf.text.pdf.PdfAction) */
    ...
    /** @see cljpdf.text.pdf.interfaces.PdfPageActions#setDuration(int) */
    public void setDuration(int seconds) {
         pdf.setDuration(seconds);
     }

    /** @see cljpdf.text.pdf.interfaces.PdfPageActions#setTransition(cljpdf.text.pdf.PdfTransition) */
